...
export function CSVUpload({ onUploadComplete }: { onUploadComplete?: () => void }) {
  ...
  const handleFile = async (selectedFile: File) => {
    ...
    try {
      ...
      setResults(data);
      await Promise.all([
        queryClient.invalidateQueries({ queryKey: ["/api/stats/hourly"] }),
        queryClient.invalidateQueries({ queryKey: ["/api/fraud-patterns"] }),
        queryClient.invalidateQueries({ queryKey: ["/api/analytics/risk-distribution"] }),
        queryClient.invalidateQueries({ queryKey: ["/api/analytics/top-fraudsters"] }),
        queryClient.invalidateQueries({ queryKey: ["/api/analytics/fraud-timeline"] }),
        queryClient.invalidateQueries({ queryKey: ["/api/analytics/merchant-analysis"] }),
        queryClient.invalidateQueries({ queryKey: ["/api/analytics/detection-breakdown"] }),
        queryClient.invalidateQueries({ queryKey: ["/api/stats/fraud"] }),
        queryClient.invalidateQueries({ queryKey: ["/api/stats/realtime"] }),
      ]);
